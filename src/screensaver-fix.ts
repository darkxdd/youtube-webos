...
/**
 * Appends a green border style to direct children of any element that are <video>.
 */
function addGlobalStyle() {
  document.head.appendChild(
    (function () {
      const x = document.createElement('style');
      x.innerHTML = '* > video { border: 1px solid transparent; }';
      return x;
    })()
  );
}
...
// Add the global style on script load.
addGlobalStyle();
